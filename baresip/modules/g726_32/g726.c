 ...
 *
 * $Id: g726.c,v 1.13 2006/09/03 04:43:46 steveu Exp $
 *
 *
 * 2012.05.08 Few little changes for tSIP and Turbo C++ Explorer (Tomasz Ostrowski):
 * - removed unnecessary g711 packing
 * - rewritten top_bits() to comply with TC++
 */
